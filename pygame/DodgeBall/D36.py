...
class Cat(pygame.sprite.Sprite):
    ...
    def load_images(self):
        self.costumes = {}          #注意：是個字典
        raw_image=pygame.image.load("res\\cat.png").convert_alpha()
        self.costumes["normal"]=pygame.transform.scale(raw_image, (95,100))
        raw_image = pygame.image.load("res\\cat2.png").convert_alpha()
        self.costumes["green"]=pygame.transform.scale(raw_image, (95,100))
        self.crnt_cstm = "normal"   #這就是決定要秀什麼顏色的key
    ...
    def update(self):
        if self.status == 1:
            ...
            if self.rect.centerx > SCREEN_WIDTH//2:   #超過中間要換邊看
    ...
    def green(self):
        self.crnt_cstm = "green"    #這裡就只改key
    
    def normal(self):
        self.crnt_cstm = "normal"   #這裡就只改key
