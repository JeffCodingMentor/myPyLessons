...
def main():
    ...
    ball_img = pygame.image.load("res\\basketball.png").convert()
    ball_img = pygame.transform.scale(ball_img, (50,50))       #把球縮小為50x50
    ball_img.set_colorkey(BLACK)
    ball_rect = ball_img.get_rect()                            #把圖用rect框起來
